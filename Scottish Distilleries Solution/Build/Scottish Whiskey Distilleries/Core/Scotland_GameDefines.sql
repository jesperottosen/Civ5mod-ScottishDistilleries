...
SELECT	'UNIT_JFD_HIGHLANDER', 	Class, PrereqTech, '30', '200',  '400', RequiresFaithPurchaseEnabled,	Moves, 	CombatClass, Domain, DefaultUnitAI, 'TXT_KEY_UNIT_JFD_HIGHLANDER', 	'TXT_KEY_CIV5_JFD_HIGHLANDER_TEXT', 'TXT_KEY_UNIT_JFD_HIGHLANDER_STRATEGY', 'TXT_KEY_UNIT_HELP_JFD_HIGHLANDER',	MilitarySupport, MilitaryProduction, Pillage, IgnoreBuildingDefense, AdvancedStartCost, CombatLimit, ObsoleteTech, '4', '4', GoodyHutUpgradeUnitClass, 'ART_DEF_UNIT_JFD_HIGHLANDER',	0,					'JFD_UNIT_FLAG_HIGHLANDER_ATLAS',	2, 				'JFD_SCOTLAND_ATLAS'
